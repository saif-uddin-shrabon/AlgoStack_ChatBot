package com.algostack.algostack_ai.Model;
...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MyViewHolder>{
    ...
    List<MessageSystem> messageList;

    public MessageAdapter(List<MessageSystem> messageList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        MessageSystem message = messageList.get(position);
        if (message.getSentBy().equals(MessageSystem.SEND_BY_ME)){
